...
#
"""
<plugin key="ThinkCleaner" name="Think Cleaner" author="RobH" version="0.1.0" wikilink="https://github.com/robhiddinga/domoticz-thinkcleaner-plugin.git" externallink="http://www.thinkcleaner.com">
    <params>
